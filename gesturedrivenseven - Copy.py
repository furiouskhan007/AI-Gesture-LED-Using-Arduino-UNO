        ...
        if results.multi_hand_landmarks:
            ...
            if len(lmList) != 0:
                ...
                if menu == 1:  # LED Color Control by Thumb Angle
                    ...
                    if -180 < thumb_to_index_angle < -135:
                        color = 'Red'
                    elif -135 <= thumb_to_index_angle < -90:
                        color = 'Purple'
                    elif -90 <= thumb_to_index_angle < -45:
                        color = 'Light Blue'
                    elif -45 <= thumb_to_index_angle < 0:
                        color = 'Blue'
                    elif 0 <= thumb_to_index_angle < 45:
                        color = 'Green'
                    elif 45 <= thumb_to_index_angle < 90:
                        color = 'Yellow'
                    elif 90 <= thumb_to_index_angle < 135:
                        color = 'Orange'
                    else:
                        color = 'None'  # Default to None if the angle is outside the expected range
